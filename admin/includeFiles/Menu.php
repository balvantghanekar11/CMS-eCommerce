        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              <li class=" nav-item"><a href="../dashboard"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>            
              </li>
              <li class=" nav-item"><a href="../admin-list/"><i class="ft-list"></i><span data-i18n="" class="menu-title">Admin List</span></a>
              </li>
              <li class=" nav-item"><a href="../product-list/"><i class="ft-package"></i><span data-i18n="" class="menu-title">Product</span></a>
              </li>
              <li class=" nav-item"><a href="../contact-us/"><i class="ft-mail"></i><span data-i18n="" class="menu-title">ContactUs</span></a>
              </li>
